...
let kCaptureShutterButtonSize = CGSize(width: 60, height: 60)
let kCaptureGalleryButtonSize = CGSize(width: 40, height: 40)
let kCaptureUndoButtonSize = CGSize(width: 40, height: 40)
extension UIButton {
    class func shutterButton() -> UIButton {
        ...
        button.frame = CGRect(x: 0, y: 0, width: kCaptureShutterButtonSize.width, height:  kCaptureShutterButtonSize.height)
...
//            )
    ...
    class func galleryButton() -> UIButton {
        ...
        let button = UIButton(type: .custom)
        button.frame = CGRect(x: 0, y: 0, width: kCaptureGalleryButtonSize.width, height:  kCaptureGalleryButtonSize.height)
    ...
    class func undoButton() -> UIButton {
        func drawUndoButton(_ color: UIColor,_ color2: UIColor, frame: CGRect = CGRect(x: 10, y: 10, width: 20, height: 20)) -> UIImage {
            ...
            //// Oval 2 Drawing
            let oval2Path = UIBezierPath(ovalIn: CGRect(x: 0, y: 0, width: kCaptureUndoButtonSize.width, height: kCaptureUndoButtonSize.height))
            color2.setFill()
            oval2Path.fill()
