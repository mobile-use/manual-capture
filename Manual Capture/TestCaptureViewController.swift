//
//  TestCaptureViewController.swift
//  Capture
//
...
class TestCaptureViewController: UIViewController, MWPhotoBrowserDelegate, ControlViewDelegate {
    var controlView: TestControlView!
    
    override func viewDidLoad() {
        controlView = TestControlView(frame: view.frame)
