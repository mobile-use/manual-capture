    ...
    func sessionControllerNotification(notification: CSNotification) {
        ...
        case .capturingPhoto(true):
            CATransaction.disableActions {
                self.sessionController.previewView.layer.opacity = 0.0
            }
            CATransaction.performBlock(duration: 0.4) {
                self.sessionController.previewView.layer.opacity = 1.0
            }
...
//            }
            ...
            newLayout.temp(root: sessionController, keyPath: \CSController2.voBlocks.focusMode, key: voKey)
...
//            }
            ...
            newLayout.temp(root: sessionController, keyPath: \CSController2.voBlocks.exposureMode, key: voKey)
        ...
        case .whiteBalance: // MARK: WhiteBalance
            ...
            newLayout.temp(root: sessionController, keyPath: \CSController2.voBlocks.whiteBalanceMode, key: voKey)
            let rows: [ControlPanel.Row] = [
                ControlPanel.Row(modeControl),
...
//
            newLayout.temp(root: me, keyPath: \CaptureView2.sessionController.voBlocks.aspectRatio, key: voKey)
            newLayout.temp(root: me, keyPath: \CaptureView2.sessionController.voBlocks.aspectRatioMode, key: voKey)
